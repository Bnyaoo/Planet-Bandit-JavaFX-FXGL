...
public class Riddles {
    ...
    HashMap<String, String> riddles;
    private Random random;
    Scanner scanner;  // Create a Scanner object

    public Riddles(Player player) {
        this.player = player;
        riddles = new HashMap<>();
        random = new Random();
        ...
        riddles.put("I follow you all the time and copy your every move, but you can’t touch me or catch me. What am I?", "Your shadow");
        riddles.put("What gets bigger when more is taken away?", "A hole");
        riddles.put("I’m found in socks, scarves and mittens; and often in the paws of playful kittens. What am I?", "Yarn");
        ...
        riddles.put("If you’ve got me, you want to share me; if you share me, you haven’t kept me. What am I?", "A secret");
        riddles.put("If you’re running in a race and you pass the person in second place, what place are you in?", "Second");
        ...
        riddles.put("What three numbers, none of which is zero, give the same result whether they’re added or multiplied? (Spell out the numbers)", "One, two and three");
        ...
        riddles.put("What is so fragile that saying its name breaks it?", "Silenc");
        riddles.put("What can fill a room but takes up no space?", "Light");
        riddles.put("If you drop me I’m sure to crack, but give me a smile and I’ll always smile back. What am I?", "A mirror");
    ...
    private String getRiddle() {
        riddleIndex = random.nextInt(0, 32);
    ...
    private String getAnswer() {
        ...
        String riddle = riddles.get(firstKey);
        return riddle;
    }
